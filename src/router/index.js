...
const routes = [
    { path : '/', component : Home, title: '홈', icon: 'fas fa-house fa-fw text-2xl' , meta: { isMenu : true, layout : 'DefaultLayout'} },
    { path : '/', component : Home, title: '탐색하기', icon: 'far fa-hashtag fa-fw text-2xl', meta: { isMenu : true, layout : 'DefaultLayout'}},
    ...
    { path : '/', component : Messages, title: '북마크', icon: 'fa-regular fa-fw fa-bookmark text-2xl', meta: { isMenu : true, layout : 'DefaultLayout'}},
    ...
    { path : '/', component : Profile , title: '더보기', icon: 'fas fa-ellipsis-h fa-fw text-2xl', meta: { isMenu : true, layout : 'DefaultLayout'}},
